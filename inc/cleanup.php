...
function roots_wp_nav_menu($text) {
  $path_array = explode('/',eas_relative_page_url());
  $path_start = $path_array[1];
  if ($path_start == 'a') $path_start = 'artists';
  if ($path_start == 'post') $path_start = 'forum';
  else if ($path_start == 'settings') $path_start = '';
  $replace = array(
    ...
    'menu-'.$path_start => 'menu-'.$path_start.' active'
  );
