...
function roots_scripts() {
  ...
  wp_enqueue_style('bootstrap_themed','/css/bootstrapthemed.css', false, null);
  ...
  wp_enqueue_script('roots_main');
    wp_register_script('placeholder', '/js/jquery.textPlaceholder.js', array('jquery'));
  wp_enqueue_script('placeholder');
  wp_register_script('filepicker', 'https://api.filepicker.io/v1/filepicker.js');
